...
1. Model / Embedding Plugins
   ...
   * [`genkitx-aws-bedrock`](https://github.com/xavidop/genkitx-aws-bedrock) ⭐ 13 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-17 - Plugin for AWS Bedrock APIs.
...
2. Vector Store Plugins
   * [`weaviate`](https://github.com/firebase/genkit/tree/main/go/plugins/weaviate) ⭐ 6,452 | 🐛 766 | 🌐 TypeScript | 📅 2026-09-18 - Plugin for Weaviate Vector Stores.
...
* [Genkit GitHub](https://github.com/firebase/genkit) ⭐ 6,452 | 🐛 766 | 🌐 TypeScript | 📅 2026-09-18 - Official GitHub repository for Genkit.
* [Genkit Dart GitHub](https://github.com/genkit-ai/genkit-dart) ⭐ 159 | 🐛 112 | 🌐 Dart | 📅 2026-09-18 - Official GitHub repository for Genkit Dart.
