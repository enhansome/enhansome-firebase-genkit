...
1. Model / Embedding Plugins
   ...
   * [`genkitx-aws-bedrock`](https://github.com/xavidop/genkitx-aws-bedrock) ⭐ 13 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-28 - Plugin for AWS Bedrock APIs.
...
2. Vector Store Plugins
   * [`weaviate`](https://github.com/firebase/genkit/tree/main/go/plugins/weaviate) ⭐ 6,390 | 🐛 753 | 🌐 TypeScript | 📅 2026-08-31 - Plugin for Weaviate Vector Stores.
...
3. Monitoring Plugin:
   * [`opentelemetry`](https://github.com/xavidop/genkit-opentelemetry-go) ⭐ 14 | 🐛 10 | 🌐 Go | 📅 2026-08-31 - Plugin for OpenTelemetry to monitor Genkit applications.
...
1. Core
   * [`genkit-java`](https://github.com/genkit-ai/genkit-java/packages) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - An unofficial Java SDK for Genkit, providing Java support for building AI-powered applications.
2. Model / Embedding Plugins
   * [`genkit-plugin-openai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/openai) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for OpenAI models (GPT-4o, GPT-4o-mini, etc.) and embeddings.
   * [`genkit-plugin-google-genai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/google-genai) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for Google Gemini models and Imagen image generation.
   * [`genkit-plugin-anthropic`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/anthropic) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for Anthropic Claude models.
   * [`genkit-plugin-aws-bedrock`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/aws-bedrock) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for AWS Bedrock models (Amazon Nova, Claude, LLaMA, Mistral, etc.).
   * [`genkit-plugin-azure-foundry`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/azure-foundry) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for Azure AI Foundry models.
   * [`genkit-plugin-xai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/xai) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for XAI (x.ai) Grok models.
   * [`genkit-plugin-deepseek`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/deepseek) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for DeepSeek models.
   * [`genkit-plugin-cohere`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/cohere) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for Cohere Command models.
   * [`genkit-plugin-mistral`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/mistral) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for Mistral AI models.
   * [`genkit-plugin-groq`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/groq) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for Groq ultra-fast inference.
   * [`genkit-plugin-ollama`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/ollama) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for local Ollama models.
   * [`genkit-plugin-compat-oai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/compat-oai) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for any OpenAI-compatible API endpoint.
3. Vector Store Plugins
   * [`genkit-plugin-localvec`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/localvec) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for local file-based vector store for development.
   * [`genkit-plugin-firebase`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/firebase) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for Firebase (Firestore vector search, Cloud Functions, telemetry).
   * [`genkit-plugin-weaviate`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/weaviate) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for Weaviate vector database.
   * [`genkit-plugin-postgresql`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/postgresql) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for PostgreSQL with pgvector.
   * [`genkit-plugin-pinecone`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/pinecone) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for Pinecone vector database.
4. Evaluator Plugins
   * [`genkit-plugin-evaluators`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/evaluators) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for pre-built RAGAS-style evaluators (faithfulness, relevancy, etc.).
5. Other Plugins
   * [`genkit-plugin-jetty`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/jetty) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - HTTP server plugin using Jetty 12.
   * [`genkit-plugin-spring`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/spring) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - HTTP server plugin using Spring Boot.
   * [`genkit-plugin-mcp`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/mcp) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Plugin for Model Context Protocol (MCP) client integration.
...
* [Genkit GitHub](https://github.com/firebase/genkit) ⭐ 6,390 | 🐛 753 | 🌐 TypeScript | 📅 2026-08-31 - Official GitHub repository for Genkit.
* [Genkit Dart GitHub](https://github.com/genkit-ai/genkit-dart) ⭐ 157 | 🐛 106 | 🌐 Dart | 📅 2026-08-31 - Official GitHub repository for Genkit Dart.
* [Genkit Java GitHub](https://github.com/genkit-ai/genkit-java) ⭐ 24 | 🐛 10 | 🌐 Java | 📅 2026-08-31 - Unofficial GitHub repository for Genkit Java.
