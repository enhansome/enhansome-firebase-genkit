...
1. Model / Embedding Plugins
   * [`genkitx-anthropic`](https://github.com/BloomLabsInc/genkit-plugins/tree/main/plugins/anthropic) ⭐ 182 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-15 - Plugin for Anthropic AI APIs.
   * [`genkitx-cohere`](https://github.com/BloomLabsInc/genkit-plugins/tree/main/plugins/cohere) ⭐ 182 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-15 - Plugin for Cohere APIs.
   ...
   * [`genkitx-github`](https://github.com/xavidop/genkitx-github) ⭐ 45 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-13 - Plugin for GitHub Models APIs.
   * [`genkitx-aws-bedrock`](https://github.com/xavidop/genkitx-aws-bedrock) ⭐ 13 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-13 - Plugin for AWS Bedrock APIs.
...
2. Vector Store Plugins
   ...
   * [`genkitx-voiceflow`](https://github.com/xavidop/genkitx-voiceflow) ⭐ 6 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-14 - Plugin for Voiceflow KB.
   * [`genkitx-redis`](https://github.com/retzd-tech/genkitx-redis) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2025-06-20 - Plugin for Redis Vector Stores.
   * [`genkitx-weaviate`](https://github.com/xavidop/genkitx-weaviate) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-13 - Plugin for Weaviate Vector Stores.
...
3. Evaluator Plugins
   * [`genkitx-promptfoo`](https://github.com/yukinagae/genkitx-promptfoo) ⭐ 7 | 🐛 7 | 🌐 TypeScript | 📅 2025-01-03 - Plugin for Promptfoo Evaluations.
4. Other Plugins
   * [`genkitx-graph`](https://github.com/TheFireCo/genkit-plugins/tree/main/plugins/graph) ⭐ 182 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-15 - Plugin for building Graph workflows.
   * [`@invertase/genkit-plugin-redis`](https://github.com/invertase/genkit-plugin-redis) ⚠️ Archived - A Redis Plugin for Genkit that adds Redis for efficient state storage, trace storage, caching, and rate limiting.
   * [`genkitx-langfuse`](https://github.com/marcelfolaron/genkitx-langfuse) ⭐ 7 | 🐛 1 | 🌐 TypeScript | 📅 2025-09-11 - Plugin to integrate with Langfuse for telemetry and prompt management.
   ...
   * [`ejentum-genkit`](https://github.com/ejentum/ejentum-genkit) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-30 - Plugin that registers four agent-callable tools (reasoning, code, anti-deception, memory) the model calls before generating. Each call returns a structured cognitive scaffold from the Ejentum Reasoning Harness.
...
2. Vector Store Plugins
   ...
   * [`weaviate`](https://github.com/firebase/genkit/tree/main/go/plugins/weaviate) ⭐ 6,336 | 🐛 717 | 🌐 TypeScript | 📅 2026-08-14 - Plugin for Weaviate Vector Stores.
...
2. Vector Store Plugins
   * [`qdrant`](https://github.com/qdrant/qdrant-genkit/tree/main/go) ⭐ 10 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-24 - Plugin for Qdrant Vector Stores.
3. Monitoring Plugin:
   * [`opentelemetry`](https://github.com/xavidop/genkit-opentelemetry-go) ⭐ 14 | 🐛 0 | 🌐 Go | 📅 2026-08-10 - Plugin for OpenTelemetry to monitor Genkit applications.
...
1. Core
   * [`genkit-java`](https://github.com/genkit-ai/genkit-java/packages) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - An unofficial Java SDK for Genkit, providing Java support for building AI-powered applications.
2. Model / Embedding Plugins
   * [`genkit-plugin-openai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/openai) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for OpenAI models (GPT-4o, GPT-4o-mini, etc.) and embeddings.
   * [`genkit-plugin-google-genai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/google-genai) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for Google Gemini models and Imagen image generation.
   * [`genkit-plugin-anthropic`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/anthropic) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for Anthropic Claude models.
   * [`genkit-plugin-aws-bedrock`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/aws-bedrock) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for AWS Bedrock models (Amazon Nova, Claude, LLaMA, Mistral, etc.).
   * [`genkit-plugin-azure-foundry`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/azure-foundry) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for Azure AI Foundry models.
   * [`genkit-plugin-xai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/xai) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for XAI (x.ai) Grok models.
   * [`genkit-plugin-deepseek`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/deepseek) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for DeepSeek models.
   * [`genkit-plugin-cohere`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/cohere) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for Cohere Command models.
   * [`genkit-plugin-mistral`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/mistral) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for Mistral AI models.
   * [`genkit-plugin-groq`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/groq) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for Groq ultra-fast inference.
   * [`genkit-plugin-ollama`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/ollama) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for local Ollama models.
   * [`genkit-plugin-compat-oai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/compat-oai) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for any OpenAI-compatible API endpoint.
3. Vector Store Plugins
   * [`genkit-plugin-localvec`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/localvec) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for local file-based vector store for development.
   * [`genkit-plugin-firebase`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/firebase) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for Firebase (Firestore vector search, Cloud Functions, telemetry).
   * [`genkit-plugin-weaviate`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/weaviate) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for Weaviate vector database.
   * [`genkit-plugin-postgresql`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/postgresql) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for PostgreSQL with pgvector.
   * [`genkit-plugin-pinecone`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/pinecone) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for Pinecone vector database.
4. Evaluator Plugins
   * [`genkit-plugin-evaluators`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/evaluators) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for pre-built RAGAS-style evaluators (faithfulness, relevancy, etc.).
5. Other Plugins
   * [`genkit-plugin-jetty`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/jetty) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - HTTP server plugin using Jetty 12.
   * [`genkit-plugin-spring`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/spring) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - HTTP server plugin using Spring Boot.
   * [`genkit-plugin-mcp`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/mcp) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Plugin for Model Context Protocol (MCP) client integration.
...
* [`Genkit Kraft`](https://github.com/DEEJ4Y/genkitkraft) ⭐ 4 | 🐛 4 | 🌐 Go | 📅 2026-07-18 - A self-hostable LLM agent platform built on the Genkit Go SDK that lets you configure, test, and deploy AI agents through a visual UI, OpenAI-compatible REST API, and MCP server support for use with AI clients like Claude.
...
* [Genkit GitHub](https://github.com/firebase/genkit) ⭐ 6,336 | 🐛 717 | 🌐 TypeScript | 📅 2026-08-14 - Official GitHub repository for Genkit.
* [Genkit Dart GitHub](https://github.com/genkit-ai/genkit-dart) ⭐ 155 | 🐛 80 | 🌐 Dart | 📅 2026-08-11 - Official GitHub repository for Genkit Dart.
* [Genkit Java GitHub](https://github.com/genkit-ai/genkit-java) ⭐ 24 | 🐛 0 | 🌐 Java | 📅 2026-08-10 - Unofficial GitHub repository for Genkit Java.
